...
> Snapshot 1
    ...
    Options:␊
      ...
      -j, --json                   Output JSON.  Implies --jsonSafe.␊
      --jsonSafe                   Do not generate types that break JSON.␊
      ...
      -z, --zalgoHeight <number>   Max Zalgo height (default: 0)␊
      -Z, --zalgoFreq <number>     Zalgo frequency (default: 0.2)␊
