 ...
 *
 * @param {InspectOptions} [options] Original opts.
 * @param {InspectOptions} [extra] Extra options to add in.
 * @returns {InspectOptions} Combined.
 * @private
 */
...
export class Basura {
  ...
  /** @import {MethodDecorator} from './decorators.js' */
  /** @type {[string, ...MethodDecorator[]][]} */
  static annotations = [
    ['Array', weak],
